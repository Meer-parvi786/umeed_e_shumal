    ...
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <img
          ...
          alt="Gilgit Baltistan Mountains Landscape"
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 text-center">
        ...
        >
          ...
          >
            ...
            Umeed e Shumal — Youth-Led Welfare Initiative in Gilgit Baltistan
          </motion.div>
        </motion.div>
        ...
        >
          Founded by Team — A youth-led welfare initiative supporting education, healthcare, and underprivileged families in Gilgit Baltistan.
        </motion.p>
